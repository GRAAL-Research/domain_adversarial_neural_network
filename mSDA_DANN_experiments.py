...
print "loading msda data (noise = 0.5)... "
xs, ys = load_representations(context_folder, dataset_name, noise = 0.5, suffix = 's')
xt, _ = load_representations(context_folder, dataset_name, noise = 0.5, suffix = 't')
xtest, ytest = load_representations(context_folder,dataset_name, noise = 0.5, suffix = 'test') 
ys = (ys + 1)/2
ytest = (ytest+1)/2
